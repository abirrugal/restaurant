...
<div class="d-flex justify-content-end">
    <a href="{{route('admin.add_ons_mat_setting')}}">
...
<form action="{{route('admin.add_ons_mat_setting.update', $info->id)}}" method="post" enctype="multipart/form-data">
    @method('put')
    @csrf
...
<div class="border p-3">
      ...
      <div class="d-flex flex-wrap flex-column mt-2">
        ...
        @foreach($info->add_amounts as $amount)
