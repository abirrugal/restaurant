                    ...
                    <table class="table">
                        <thead class="text-uppercase bg-primary">
                            <tr class="text-white">
                                ...
                                <th scope="col">Assigned Waiter</th>

                                @if (auth()->user()->role_as === 'superadmin')
                                <th scope="col">Set Waiter For This User</th>  
                                @endif
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($slider_image->waiter !== null)

                                <td>{{$slider_image->waiter->name}}</td>
                                ...
                                @endif
                                    ...
                                    <td>
                                        ...
                                        <form class="d-flex" action="{{route('admin.waiter.role_change')}}" method="POST" >
                                            @csrf
                                          @method('put')
                                      
                                            <input class="w-50" type="hidden" name="user_id" value="{{$slider_image->id}}">
                                                <select class="form-select" name="role" id="">
                                                    @foreach ($waiter_list as $item)
