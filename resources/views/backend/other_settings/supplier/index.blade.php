...
>
  <i class="fa fa-edit"> </i> Create a Supplier
</button>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header action_button text-white">
        <h6 class="modal-title" id="staticBackdropLabel"><i class="fa fa-edit"> </i> Create New Supplier</h6>
...
<div class="form-row mt-4">
  ...
  <div class="col">
    <div class="mb-3">
      <label for="number" class="form-label text-black h6">Supplier Name</label>  
      <input type="text" name="name" value="{{old('name')}}" class="form-control" id="name" aria-describedby="PriceHelp" placeholder="Supplier Name" required>
...
<div class="col">
<div class="mb-3">
  <label for="number" class="form-label text-black h6">Supplier Number</label>  
  <input type="number" name="number" value="{{old('number')}}" class="form-control" id="number" aria-describedby="PriceHelp" placeholder="Supplier Number" required>
...
<div class="form-floating">
    ...
    <label for="floatingTextarea2">Supplier Address</label>
  </div>
  ...
  <div class="col">
    <div class="mb-3">
      ...
      <input type="number" name="balance" value="{{old('balance')}}" class="form-control" id="number" aria-describedby="PriceHelp" placeholder="Supplier balance" required>
...
@endif
      ...
      <td class="text-center">
        <a class="text-center" href="{{route('admin.supplier.change_sts', $info->id)}}"><i class="fas fa-exchange-alt d-block"></i></a>
      </td>
      <td>
...
<div class="modal fade" id="edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header action_button text-white">
        <h6 class="modal-title" id="editLabel"><i class="fa fa-edit"> </i> Edit Supplier</h6>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <div class="modal-body">
        ...
        <form action="{{route('admin.supplier.update', $info->id)}}" method="post" enctype="multipart/form-data">
          @method('put')
          @csrf
...
<div class="form-row mt-4">
    ...
    <div class="col">
        <div class="mb-3">
          <label for="number" class="form-label text-black h6">Supplier Name</label>  
          <input type="text" name="name" value="{{old('name')}}" class="form-control" id="ename" aria-describedby="PriceHelp" placeholder="Supplier Name" required>
    ...
    <div class="mb-3">
      <label for="number" class="form-label text-black h6">Supplier Number</label>  
      <input type="number" name="number" value="{{old('number')}}" class="form-control" id="enumber" aria-describedby="PriceHelp" placeholder="Supplier Number" required>
    ...
    <div class="form-floating">
      ...
      <div class="col">
        <div class="mb-3">
          <label for="number" class="form-label text-black h6">Balance</label>  
          <input type="number" name="balance" value="{{old('balance')}}" class="form-control" id="ebalance" aria-describedby="PriceHelp" placeholder="Supplier balance" required>
    ...
    <input type="hidden" id="id">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" onclick="updatedata()">Edit Supplier</button>
      </div>
 </form>
      </div>
...
@if (auth()->user()->role_as !== 'creator')
         ...
         <form class="d-inline " onclick="return confirm('Sure to delete product ?')"  action="{{route('admin.supplier.delete', $info->id)}}" method="POST">
          @csrf
          @method('Delete')
...
<script>
  ...
  function editdata(id){
    $.ajax({
        ...
        url: "{{asset('/')}}admin/supplier/edit/"+id,
